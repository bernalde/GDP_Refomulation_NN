...
equation obj, disj_ineq(k,i,e), sum_bin(k), disag(k,var), bound_up(k,i,var), bound_lo(k,i,var), eq_useless_k;
...
model prob /obj,disag,disj_ineq,sum_bin,bound_up,bound_lo, eq_useless_k/;
